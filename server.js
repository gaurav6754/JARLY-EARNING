...
// Connect to MongoDB to ensure data persists across restarts/redeploys[span_2](start_span)[span_2](end_span)
...
app.listen(PORT, () => console.log(`Jarly backend listening on port ${PORT}`));
